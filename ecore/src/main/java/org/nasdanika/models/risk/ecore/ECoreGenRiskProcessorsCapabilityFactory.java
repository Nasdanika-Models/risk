...
public class ECoreGenRiskProcessorsCapabilityFactory implements CapabilityFactory<TargetRequirement, Object> {
		...
		return CompletableFuture.completedStage(
				Collections.singleton(
						CapabilityProvider.of(
								new EcoreGenRiskProcessorsFactory(requirement.requirement().context()))));
	}
