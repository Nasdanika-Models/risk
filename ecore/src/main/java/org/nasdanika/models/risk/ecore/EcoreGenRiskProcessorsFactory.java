package org.nasdanika.models.risk.ecore;
...
@EPackageNodeProcessorFactory(nsURI = RiskPackage.eNS_URI)
public class EcoreGenRiskProcessorsFactory {

	private Context context;
		
	public EcoreGenRiskProcessorsFactory(Context context) {
		...
		return new EPackageNodeProcessor(config, context, prototypeProvider) {
			...
			protected void generateDiagramAndGraphActions(Collection<Label> labels, ProgressMonitor progressMonitor) {
				...
				try {
					...
					Files.writeString(new File("target/risk.drawio").toPath(), document.save(null));
				} catch (Exception e) {
					e.printStackTrace();
