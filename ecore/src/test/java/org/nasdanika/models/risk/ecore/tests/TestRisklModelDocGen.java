package org.nasdanika.models.risk.ecore.tests;
...
import org.nasdanika.models.risk.ecore.EcoreGenRiskProcessorsFactory;
 ...
 *
 */
public class TestRisklModelDocGen {
	
	@Test
	public void testGenerateRiskModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenRiskProcessorsFactory ecoreGenFamilyProcessorFactory = new EcoreGenRiskProcessorsFactory(context);		
		...
		File output = new File(actionModelsDir, "risk.xmi");
